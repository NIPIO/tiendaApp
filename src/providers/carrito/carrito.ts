...
export class CarritoProvider {
	...
	realizarPedido() {
		...
		let url = URL_SERVICIOS + '/pedidos/realizarPedido';
		let data = new HttpParams();
		data = data.append('items', itemsEnviarStr)
		data = data.append('user', this._userv.usuario)
		let peticion = this._http.post(url, data)
			.map(resp => resp)
